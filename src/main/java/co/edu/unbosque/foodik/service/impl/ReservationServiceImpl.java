...
public class ReservationServiceImpl implements ReservationService {
    ...
    public ReservationResponse updateStatus(UUID id, ReservationStatus status, String adminEmail) {
        ...
        if (status == ReservationStatus.COMPLETED) {
            billRepository.findByReservationId(id).ifPresent(bill -> {
    ...
    private ReservationResponse toResponse(Reservation r) {
        return new ReservationResponse(r.getId(), r.getUser().getId(), r.getUser().getName(),
                r.getRestaurant().getId(), r.getRestaurant().getName(), r.getTableSlot().getId(),
                r.getPartySize(), r.getStatus(), r.getReservationDate(), r.getReservationTime(),
